...
public class ROMController {
    ...
    public ROMEntity getROMById(@RequestParam Long id){
        return romService.findById(id);
    }

    @GetMapping(value = "find-by-model")
    public ROMEntity getROMByModel(@RequestParam String model){
...
//    public ResponseEntity<List<ROMEntity>> getROMs(@RequestBody Map<String,Object>page){
//        Page<ROMEntity> p = romService.filterRom(universalPage,romSearchCriteria);
